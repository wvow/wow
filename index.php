...
define('CAMPAIGN_ID', "7ab1e83a9d2e7031ca75ee34306967cf");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', 'd53f88fc178f20761a62e8740a5d5be8');
define('MP_PARAM_NAME', '__aa_clk');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', '854ce8d2b05c29c3abc966a9f94514d9');
define('CHECK_MCPROXY_VALUE', '39af291bbbeec04c6960de82d47e7cb23d4563fc945e22b0adb30a1dbf8055d9');
...
function sendRequest($data, $path = 'index') {
    ...
    $data_to_post = array("cmp"=> CAMPAIGN_ID,"headers" => $data,"adapi" => '2.2', "sv" => '6475.3');
